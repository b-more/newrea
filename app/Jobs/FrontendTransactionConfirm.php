...
class FrontendTransactionConfirm implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        {
            Log::info("Background Airtel", ["Stated" => json_encode($initialised_transaction)]);
    ...
    function createTransactionSparkApi($payment_id, $customer_id, $amount, $ref_number, $phone_number): void
    {
        ...
        if($http_status_code == 201){
            ...
            $message_string = "You have successfully topped up your electricity. Transaction number ".$transaction_id;
